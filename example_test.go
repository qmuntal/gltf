...
func ExampleSave() {
	doc := &gltf.Document{
		...
		Materials: []*gltf.Material{{
			...
			PBRMetallicRoughness: &gltf.PBRMetallicRoughness{BaseColorFactor: &[4]float32{0.8, 0.8, 0.8, 1}, MetallicFactor: gltf.Float64(0.1), RoughnessFactor: gltf.Float64(0.99)},
		}},
