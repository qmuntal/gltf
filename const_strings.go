// Code generated by "stringer -linecomment -type ComponentType,AccessorType,PrimitiveMode,AlphaMode,MagFilter,MinFilter,WrappingMode,Interpolation,Target -output const_strings.go"; DO NOT EDIT.
