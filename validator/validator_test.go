...
func TestValidateDocument(t *testing.T) {
	...
	tests := []struct {
		...
		{"Document.Cameras[0].Ortographic.Znear", args{&gltf.Document{Asset: gltf.Asset{Version: "1.0"},
			Cameras: []gltf.Camera{{Type: gltf.OrtographicType, Ortographic: &gltf.Ortographic{Znear: -1, Zfar: 1}}}}}, true},
		{"Document.Cameras[0].Ortographic.Zfar", args{&gltf.Document{Asset: gltf.Asset{Version: "1.0"},
			Cameras: []gltf.Camera{{Type: gltf.OrtographicType, Ortographic: &gltf.Ortographic{Znear: 1, Zfar: 1}}}}}, true},
